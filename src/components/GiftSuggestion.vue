...
<template>
	<section id="gifts" class="relative bg-paper px-6 sm:px-10 py-6 text-olive-900 reveal-on-scroll">
		<div class="mx-auto max-w-sm">
			<div class="grid grid-cols-[48px_1fr] gap-4 sm:gap-6 items-start text-left">
				<!-- Gift Box Icon (Line Art) -->
				<div class="flex items-center justify-center text-olive-800 pt-1">
					<svg class="h-10 w-10 stroke-[1.2]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
						<path d="M20 12v9H4V12M2 7h20v5H2zM12 21V7" />
				...
				<div class="flex flex-col items-start">
					...
					<p class="mt-2 font-serif text-xs leading-relaxed text-olive-700 font-normal">
						Su presencia es nuestro mejor regalo. Sin embargo, si desean hacernos un presente, una contribución en efectivo será de gran ayuda para nuestra nueva etapa juntos.
					</p>
